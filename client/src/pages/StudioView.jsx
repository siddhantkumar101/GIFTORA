  ...
  return (
    <div className="min-h-screen flex flex-col space-y-12 animate-fade-in">
      ...
      <section className="grid gap-10 md:gap-12 grid-cols-1 lg:grid-cols-[1fr_420px]">
        {/* Left Column: Product Catalog (Order 2 on mobile) */}
        <div className="order-2 lg:order-1 space-y-8 overflow-y-auto col-scroll">
            <div className="flex flex-col gap-6 border-b border-slate-100 pb-6 sm:flex-row sm:items-center sm:justify-between">
               <h3 className="text-lg font-black sm:text-2xl">1. Browse Products</h3>
        ...
        <div className="order-1 lg:order-2 space-y-6 sm:space-y-8 sticky top-[80px] lg:static z-20 bg-bg-main/95 backdrop-blur-sm lg:backdrop-blur-none py-4 lg:py-0 border-b border-slate-100 lg:border-none" ref={customizerRef}>
           ...
           <div className="pt-2 sm:pt-4">
              <p className="mb-2 sm:mb-4 text-[10px] sm:text-sm font-bold uppercase tracking-widest text-slate-400 text-center">Live Product Proof</p>
